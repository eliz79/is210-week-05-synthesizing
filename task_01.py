...
def farenheit_to_kelvin(degrees):
    ...
    """A function that will convert degrees from Farenheit to Kelvin
    ...
    Example:
        ...
        Decimal('373.15')
        """
    return farenheit_to_celsius(degrees) + ABSOLUTE_DIFFERENCE

F_TO_K = farenheit_to_kelvin(212) + ABSOLUTE_DIFFERENCE
print F_TO_K
